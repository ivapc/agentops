...
az webapp deploy -g rg-ivan-dev -n agntops --subscription 77e69dbb-cf80-4ca0-a4f0-c9adf9550c37 --src-path deploy.zip --type zip --clean true
```
...
curl -X PUT "https://agntops.scm.azurewebsites.net/api/vfs/data/agentops.db" --data-binary @/tmp/agentops-deploy.db -H "Content-Type: application/octet-stream" -H "Authorization: Bearer $TOKEN" -H "If-Match: *"
```
